        ...
        <div class="content_right">
            ...
            <div class="mypage_top">
                ...
                <ul class="mypage_toplist">
                    <li><a href="/mypageT/activity/boardlist?userId=tr1">TR 게시판</a></li>
                    <li><a href="/mypageT/activity/boardlike?userId=tr1">좋아요</a></li>
                    <li><a href="/mypageT/activity/boardreplye?userId=tr1" class="on">댓글</a></li>
                </ul>
            ...
            <div>
                ...
                <ul class="mypage_top_tabs">
                    <li><a href="/mypageT/activity/boardreplye?userId=tr1" class="on"><span class="on2"></span> 전체</a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <c:forEach var="pageNum" begin="${__PAGENATION__.startPage}" end="${__PAGENATION__.endPage}">
                            ...
                            <!-- Userid 세션에서 받아 오는 것으로 수정해야 된다!!(********) -->
                                <a 
                                    href="/mypageT/activity/boardreplye?userId=user2&currPage=${pageNum}" 
