        ...
        <div class="content_right">
            ...
            <div>
                ...
                <ul class="mypage_top_tabs">
                    <li><a href="/mypageT/activity/boardlist?userId=tr1"><span></span> 전체</a></li>
                    <li><a href="/mypageT/activity/boardreplydone?userId=tr1" class="on"><span class="on2"></span> 답변 완료</a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <c:forEach var="pageNum" begin="${__PAGENATION__.startPage}" end="${__PAGENATION__.endPage}">
                            ...
                            <!-- Userid 세션에서 받아 오는 것으로 수정해야 된다!!(********) -->
                                <a 
                                    href="/mypageT/activity/boardreplydone?userId=user2&currPage=${pageNum}" 
