    ...
    <script>
        ...
        $(function() {
            ...
            $('a.prev, a.next').click( function (e) {
                ...
                formObj.attr('action', '/mypageT/activity/boardlike');
    ...
    <section class="content">
        ...
        <nav class="content_left">
            ...
            <div class="profile">
                ...
                <a href="/mypageT/profile/myprofile" class="profile_email">helloword@naver.com <i class="fas fa-angle-right"></i> </a>
        ...
        <div class="content_right">
            ...
            <div class="mypage_top">
                ...
                <ul class="mypage_toplist">
                    ...
                    <li><a href="/mypageT/activity/boardlike?userId=tr1" class="on">좋아요</a></li>
            ...
            <div>
                ...
                <ul class="mypage_top_tabs">
                    <li><a href="/mypageT/activity/boardlike?userId=tr1" class="on"><span class="on2"></span> 전체</a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <c:forEach var="pageNum" begin="${__PAGENATION__.startPage}" end="${__PAGENATION__.endPage}">
                            ...
                            <!-- Userid 세션에서 받아 오는 것으로 수정해야 된다!!(********) -->
                                <a 
                                    href="/mypageT/activity/boardlike?userId=user2&currPage=${pageNum}" 
