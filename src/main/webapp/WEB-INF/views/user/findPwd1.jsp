<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <!-- bootstrap v5 -->
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/css/bootstrap.min.css?ver=1.1"
            ...
            <%@ include file="/WEB-INF/views/include/header.jsp" %>
                ...
                <section class="login-contain">
                    <div class="inner_box">
                        ...
                        <form action="/user/find/pwd" id="findpwd_form" class="findpwd" name="findpwd_form"
                            method="POST">
                                ...
                                <div class="inner-list">
                                    <div class="la_input">
                                        ...
                                        <div class="input_group">
                                            <input type="text" class="form-control-sm" name="userId" id="userId"
                                                minlength="8" maxlength="15" placeholder="8-15자의 영문 소문자, 숫자만 가능합니다."
                                                required>
                                        </div>
                                     </div>
                                 </div>
                                    ...
                                    <div class="la_input">
                                        ...
                                        <div class="input_group">
                                            <input type="text" class="form-control-sm" name="userName" id="userName"
                                                minlength="2" maxlength="15" placeholder="김영희" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="inner-list">
                                    <div class="la_input">
                                        ...
                                        <div class="input-group putbtn">
                                            <input type="text" class="form-control" name="userPhone" id="user_phone"
                                                minlength="10" maxlength="13" placeholder=" ' - ' 제외하고 입력해주세요"
                                                aria-describedby="button-addon2" required>
                                            <button class="btn btn-outline-secondary putbtn" type="button"
                                                id="phoneChk">코드전송</button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="la_input">
                                            ...
                                            <div class="input-group putbtn">
                                                <input type="text" class="form-control" name="userPhone2"
                                                    id="user_phone2" length="11" placeholder=" 인증번호를 입력해주세요"
                                                    aria-label="Recipient's username" aria-describedby="button-addon2">
                                                <button class="btn btn-outline-secondary putbtn" type="button"
                                                    id="phoneChk2">인증하기</button>
