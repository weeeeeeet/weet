                    ...
                    <div class="select-box">
                        <form action="">
                            <div class="check-box">
                                ...
                                <ul>
                                    <li><span class="search-title">수신동의 </span>:</li>
                                    <li><input type="checkbox" name="agmtype_chkAll" id="agmtype_chkAll" value="allAagmtype_chkAll" checked> 전체
                                    </li>
                                    <li><input type="checkbox" name="agmtype_chk" value="SMS" checked> SMS</li>
                                    <li><input type="checkbox" name="agmtype_chk" value="Email" checked> E-mail</li>
                                </ul>
                            </div>
