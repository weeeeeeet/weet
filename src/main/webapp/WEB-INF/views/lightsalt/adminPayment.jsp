                ...
                <div class="inner">
                    ...
                    <div class="select-box">
                        <form action="">
                            <div class="check-box">
                                <ul>
                                    <li><span class="search-title">결제상태</span>:</li>
                                    <li><input type="checkbox" name="paystatus_chkAll" id="paystatus_chkAll" value="paystatus_chkAll" checked> 전체
                                    </li>
                                    <li><input type="checkbox" name="paystatus_chk" value="pay1" checked> 미결제</li>
                                    <li><input type="checkbox" name="paystatus_chk" value="pay2" checked> 결제완료</li>
                                    <li><input type="checkbox" name="paystatus_chk" value="pay3" checked> 결제실패</li>
                                    <li><input type="checkbox" name="paystatus_chk" value="pay4" checked> 결제취소</li>
                                </ul>
                                <ul>
                                    <li><span class="search-title">결제수단</span>:</li>
                                    <li><input type="checkbox" name="paytype_chkAll" id="paytype_chkAll" value="paytype_chkAll" checked> 전체
                                    </li>
                                    <li><input type="checkbox" name="paytype_chk" value="P" checked> 카카오페이</li>
                                    <li><input type="checkbox" name="paytype_chk" value="P" checked> TOSS페이</li>
                                    <li><input type="checkbox" name="paytype_chk" value="G" checked> 실시간계좌이체</li>
                                    <li><input type="checkbox" name="paytype_chk" value="G" checked> 가상계좌</li>
                                </ul>
                                    ...
                                    <li>
                                        <div class="search-bar">
                                            <select class="search-select" name="search-type">
                                                ...
                                                <option value="return_date">반려일시</option>
                                            </select>
