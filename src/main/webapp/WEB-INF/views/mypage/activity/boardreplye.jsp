...
<head>
    ...
    <link href="/resources/css/mypage/mypage1.css" rel="stylesheet" />
    <link href="https://webfontworld.github.io/SCoreDream/SCoreDream.css" rel="stylesheet">
    <script src="https://kit.fontawesome.com/63eb3bc178.js" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        $(function() {
            ...
            $('a.prev, a.next').click( function (e) {
                ...
                formObj.attr('action', '/mypage/activity/boardreplye');
        ...
        <div class="content_right">
            ...
            <div class="mypage_top">
                ...
                <ul class="mypage_toplist">
                    <li><a href="/mypage/activity/boardlist">TR 게시판</a></li>
                    <li><a href="/mypage/activity/boardlike">좋아요</a></li>
                    <li><a href="/mypage/activity/boardreplye" class="on">댓글</a></li>
                </ul>
            ...
            <div>
                ...
                <ul class="mypage_top_tabs">
                    <li><a href="/mypage/activity/boardreplye" class="on"><span class="on2"></span> 전체</a></li>
                </ul>
            ...
            <table class="TR_tables">
                ...
                <tbody>
                    ...
                    <c:forEach var="board" items="${__LIST__}">
                        <tr class="tb1">
                            <td class="tr_no"><a>${board.replyId}</a></td>
                            <td><a href="#" class="tr_title">${board.replyContents}</a></td>
                            <td class="tr_date"><fmt:formatDate pattern="yyyy/MM/dd" value="${board.replyUpdateTs}" /></td>
                        </tr>
                    </c:forEach>
                    ...
                    <ul>
                        ...
                        <c:forEach var="pageNum" begin="${__PAGENATION__.startPage}" end="${__PAGENATION__.endPage}">
                            ...
                            <!-- Userid 세션에서 받아 오는 것으로 수정해야 된다!!(********) -->
                                <a 
                                    href="/mypage/activity/boardreplye?userId=user2&currPage=${pageNum}" 
