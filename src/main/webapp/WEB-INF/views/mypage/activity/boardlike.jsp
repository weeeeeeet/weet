    ...
    <script>
        ...
        $(function() {
            ...
            $('a.prev, a.next').click( function (e) {
                ...
                formObj.attr('action', '/mypage/activity/boardlike');
        ...
        <div class="content_right">
            ...
            <div class="mypage_top">
                ...
                <ul class="mypage_toplist">
                    ...
                    <li><a href="/mypage/activity/boardlike" class="on">좋아요</a></li>
            ...
            <div>
                ...
                <ul class="mypage_top_tabs">
                    <li><a href="/mypage/activity/boardlike?userId=${userId}" class="on"><span class="on2"></span> 전체</a></li>
                </ul>
                    ...
                    <ul>
                        ...
                        <c:forEach var="pageNum" begin="${__PAGENATION__.startPage}" end="${__PAGENATION__.endPage}">
                            ...
                            <!-- Userid 세션에서 받아 오는 것으로 수정해야 된다!!(********) -->
                                <a 
                                    href="/mypage/activity/boardlike?userId=user2&currPage=${pageNum}" 
