    ...
    <script>
        ...
        $(function() {
            ...
            $('#class_card_btn').click( function (e) {
                ...
                let val = $('#modal_class_title').text();
                replyForm.find("input[name='modal_class_title']").val(val);
                // $('#modal_class_title').val(document.getElementById("card-text").innerHTML); 
                //$('#modal_class_title').text(document.getElementById("card-text").innerHTML);
                    ...
                    <div class="modal-content">
                        ...
                        <form action="/mypage/class/expired" method="post" enctype="multipart/form-data" id="replyForm">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" class="modal_class_title" name="modal_class_title" readonly>
                                <!-- <p class="modal_class_title"></p> -->
