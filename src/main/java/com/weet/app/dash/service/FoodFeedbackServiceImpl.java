...
import com.weet.app.dash.mapper.FoodFeedbackMapper;
...
public class FoodFeedbackServiceImpl implements FoodFeedbackService, InitializingBean, DisposableBean {
	...
	//==================================================
	@Override
	public List<FeedbackVO> getAllFoodList() throws ServiceException {
		log.trace("getAllFoodList() invoked.");
		
		try { return mapper.selectAllFoodList(); }
