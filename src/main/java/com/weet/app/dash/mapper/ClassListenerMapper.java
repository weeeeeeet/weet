...
import com.weet.app.dash.domain.ClassListenerVO;
...
public interface ClassListenerMapper {
	
	//==================================================
	// 1. pt 남은 횟수
	//==================================================
	public abstract List<ClassListenerVO> selectAllNoticeList() throws DAOException;
